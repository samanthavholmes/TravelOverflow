...
questions = Question.create! [{ :title => "Cheap place to travel to?", :description => "Going on a vacation in July. I don't want to spend a lot of money. Where should I go?", :user_id => rand(1..20)},
                             ...
                             { :title => "Roadtrip anyone?", :description => "I have a car and gas is cheap. Where should I go? I'm leaving from NYC. Also, does anyone want to come with me?", :user_id => rand(1..20)},
                             { :title => "Is Morocco safe?", :description => "I'm going to Morocco, is it safe for a woman traveling alone?", :user_id => rand(1..20)},
                             ...
                             { :title => "Best gelato in Florence?", :description => "I love gelato, what is the best place to go!?", :user_id => rand(1..20)}]
